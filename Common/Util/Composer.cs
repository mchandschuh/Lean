...
namespace QuantConnect.Util
{
    ...
    public class Composer
    {
        ...
        // lazily defined
        private static readonly Lazy<Composer> ComposerInstance = new Lazy<Composer>(() => new Composer());
        ...
        public static Composer Instance => ComposerInstance.Value;
        ...
        private void Initialize()
        {
            ...
            _compositionContainer = Task.Run(() =>
            {
                ...
                var assemblyCatalogs = EnumerateFiles(PrimaryDllLookupDirectory, "*.dll")
                    ...
                    //.Where(fn => Path.GetFileName(fn)?.StartsWith(nameof(QuantConnect)) != true)
